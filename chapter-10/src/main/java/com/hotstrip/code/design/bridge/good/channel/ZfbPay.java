...
public class ZfbPay extends Pay {
    ...
    public String transfer(String userId, String tradeId, BigDecimal amount) {
        ...
        log.info("模拟支付宝渠道支付风控校验，userId：{}，tradeId：{}，security：{}", userId, tradeId, security);
        if (!security) {
            log.info("模拟支付宝渠道支付划账拦截，userId：{}，tradeID：{}，amount：{}", userId, tradeId, amount);
            return "0001";
        }
        log.info("模拟支付宝渠道支付划账成功，userId：{}，tradeID：{}，amount：{}", userId, tradeId, amount);
        return "0000";
    }
}
