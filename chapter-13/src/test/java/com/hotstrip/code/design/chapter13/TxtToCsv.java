...
//     */
//    @Test
//    public void testTxtToCsv() throws FileNotFoundException {
//        String txtFilePath = "/Users/zhangxin/Documents/大都会/运营活动数据20210401-20210616/原始数据/20210408.txt";
//        String csvFilePath = "/Users/zhangxin/Documents/大都会/运营活动数据20210401-20210616/csv/20210408.csv";
//
...
//     */
//    @Test
//    public void testTxtToCsv2() {
//        String txtFilePath = "/Users/zhangxin/Documents/大都会/运营活动数据20210401-20210616/原始数据/";
//        String csvFilePath = "/Users/zhangxin/Documents/大都会/运营活动数据20210401-20210616/csv/明细数据.csv";
//
//        File directory = new File(txtFilePath);
//        Arrays.stream(directory.listFiles()).forEach(file -> {
//            try {
//                log.info("current file: {}", file.getName());
//                txtToCsv(file.getAbsolutePath(), csvFilePath);
...
//        String txtFilePath = "/Users/zhangxin/Documents/大都会/运营活动数据20210401-20210616/原始数据/";
//        String csvFilePath = "/Users/zhangxin/Documents/大都会/运营活动数据20210401-20210616/csv/明细数据表.csv";
//
...
//        String csvFilePath1 = "/Users/zhangxin/Documents/大都会/运营活动数据20210401-20210616/csv/明细数据表.csv";
//        String csvFilePath2 = "/Users/zhangxin/Documents/大都会/运营活动数据20210401-20210616/csv/每天交易优惠金额汇总表.csv";
//
...
//        ConcurrentHashMap<String, String> map = initMap();
//        log.info(map.get("202008312031509320400000001345"));
//    }
    ...
    private ConcurrentHashMap initMap() throws FileNotFoundException {
        String filePath = "/Users/zhangxin/Documents/大都会/运营活动数据20210401-20210616/tbl_dtbmgm_token_inf.txt";
    ...
    private void txtToCsv(String txtFilePath, String csvFilePath) throws FileNotFoundException {
        AtomicInteger atomicInteger = new AtomicInteger();
        ...
        reader.lines().forEach(line -> {
            if (atomicInteger.get() > 0) {
                ...
                row[7] = getUserName(row[7]);
                row[8] = getDataToString(row[8]);
                writer.write(row);
            }
            atomicInteger.incrementAndGet();
        });
    ...
    private String getUserName(String s) {
        final String data = AESTest.decrypt(getData(s));
