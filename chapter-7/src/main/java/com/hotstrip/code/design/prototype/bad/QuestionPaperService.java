...
public class QuestionPaperService {
     ...
     * @return
     */
    public String createPaper(final String candidate, final String number) {
        ...
        choiceQuestionList.add(new ChoiceQuestion("JAVA 所定义的版本中不包括",
                map01, "D"));
        ...
        choiceQuestionList.add(new ChoiceQuestion("以下（）不是合法的标识符",
                map04, "C"));
        choiceQuestionList.add(new ChoiceQuestion("表达式（11+3*8）/4%3 的值是",
                map05, "C"));

        answerQuestionList.add(new AnswerQuestion("小红马和小黑马生的小马有几条腿", "4 条腿"));
